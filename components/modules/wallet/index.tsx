...
import { mainnet, optimism, arbitrum, base, bsc, polygon, avalanche, celo, gnosis, fantom, linea, scrollSepolia, sepolia, mantle, blast, mode } from '@reown/appkit/networks'
